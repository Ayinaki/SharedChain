...
public class RedirectionListener implements Listener {
    ...
    public RedirectionListener(SharedChain plugin) {
        this.plugin = plugin;
    }
    ...
    public void onEntityPortal(EntityPortalEvent event) {
        ...
        if (toWorld.getKey().equals(SharedChain.REAL_OVERWORLD_KEY)) {
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        if (player.getWorld().getKey().equals(SharedChain.REAL_OVERWORLD_KEY)) {
    ...
    public void onPlayerRespawn(PlayerRespawnEvent event) {
        ...
        if (respawnLoc.getWorld().getKey().equals(SharedChain.REAL_OVERWORLD_KEY)) {
